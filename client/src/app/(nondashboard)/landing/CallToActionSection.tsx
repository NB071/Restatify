	...
	return (
		<section className="relative py-24">
			<Image
				...
				alt="Restatify CTA Section Background"
				...
				<div className="flex flex-col md:flex-row justify-between items-center">
					...
					<div>
						<p className="text-white mb-3">
							Discover a wide range of retal properties in your
							desiered location.
						</p>
						<div className="flex justify-center md:justify-start gap-4">
							...
							<Link
								href="/signup"
								className="inline-block text-white rounded-lg bg-secondary-500 px-6 py-3 font-semibold hover:bg-secondary-600"
								scroll={false}
							>
								Sign Up
							</Link>
